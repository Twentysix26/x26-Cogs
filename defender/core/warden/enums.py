...
class Action(enum.Enum):
    ...
    PunishUserWithMessage = (
        "punish-user-with-message"  # Assign the punish role to the user and send the set message
    )
    ...
    SendMessage = (
        "send-message"  # Send a message to an arbitrary destination with an optional embed
    )
